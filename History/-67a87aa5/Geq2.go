...
func getNFOTokens() ([]string, error) {
	...
	niftybankMaxCEStrike := nifty50IndiceLastTradePrice + 500.0
	niftybankMinCEStrike := nifty50IndiceLastTradePrice - 100.0
	niftybankMaxPEStrike := nifty50IndiceLastTradePrice + 100.0
	niftybankMinPEStrike := nifty50IndiceLastTradePrice - 500.0
