...
type FormattedQuoteResult struct {
	FormattedQuote []Quote `json:"FormattedQuote"`
}

type FormattedQuoteData struct {
	FairValueQuoteResult FormattedQuoteResult `json:"FormattedQuoteResult"`
}
