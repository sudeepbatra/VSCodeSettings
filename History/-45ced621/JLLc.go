...
func GetInstrumentsSymbolAndTokenMapping() (map[InstrumentKey]int, map[int]InstrumentKey, error) {
	...
	symbolToTokenMap := make(map[InstrumentKey]int)
	tokenToSymbolMap := make(map[int]InstrumentKey)
	...
	for _, instrument := range instruments {
		...
		key := InstrumentKey{Symbol: instrument.Symbol, Exchange: instrument.Exchange}
