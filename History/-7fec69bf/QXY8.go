...
func InitializeTables() {
	...
	if err != nil {
		logger.Log.Error().Err(err).Msg("Error in creating tick data table table")
	}
	...
	tickDataIndexQuery := fmt.Sprintf("CREATE INDEX idx_token_exchangetype_exchangetimestamp ON tick_data (token, exchangetype, exchangetimestamp);",
