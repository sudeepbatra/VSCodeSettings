...
func NewAlphaSignal(token string, symbol string, exchangeCode int, exchange, interval string, lastBarStartDuration time.Time,
	strategyName string, IsStrategyLive bool, signal string, signalGenerationTime time.Time,
	price, o, h, l, c float64, v int, alphaSignalReason string, isHistorical bool,
) (*AlphaSignal, error) {
	switch signal {
