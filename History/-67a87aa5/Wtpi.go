...
func getNFOTokens() ([]string, error) {
	...
	niftybankMinCEStrike := niftybankIndiceLastTradePrice - 100.0
	niftybankMaxPEStrike := niftybankIndiceLastTradePrice + 100.0
	niftybankMinPEStrike := niftybankIndiceLastTradePrice - 500.0
