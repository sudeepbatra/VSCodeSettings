...
func processResponse(respBytes []byte) {
	...
	parsedData.SequenceNumber = unpackData(respBytes[27:35])
	parsedData.ExchangeTimestamp = unpackData(respBytes[35:43])
	parsedData.LastTradedPrice = unpackData(respBytes, 43, 51, "I")
}
