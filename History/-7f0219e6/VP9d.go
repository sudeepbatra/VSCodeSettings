...
func unpackBestFiveData(data []byte) ([]Best5TickData, []Best5TickData, []Best5TickData, error) {
	var bestFiveData, best5BuyData, sellData []Best5TickData
	...
	logger.Log.Info().
		Interface("bestFiveData", bestFiveData).
		Interface("buyData", best5BuyData).
		Interface("sellData", sellData).
		Msg("Received best five data")

	return bestFiveData, best5BuyData, sellData, nil
}
