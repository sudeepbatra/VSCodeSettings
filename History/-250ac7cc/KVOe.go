...
func init() {
	...
	webSocketLogFile, err := os.OpenFile("websocket.log", os.O_APPEND|os.O_CREATE|os.O_WRONLY, 0o644)
	if err != nil {
		panic(err)
	}
	...
	WebSocketLog = zerolog.New(webSocketLogFile).With().Timestamp().Logger()
}
