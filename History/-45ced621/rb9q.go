...
func GetInstrumentsSymbolAndTokenMapping() (map[smartapi.InstrumentSymbolKey]smartapi.InstrumentTokenKey, map[smartapi.InstrumentTokenKey]smartapi.InstrumentSymbolKey, error) {
