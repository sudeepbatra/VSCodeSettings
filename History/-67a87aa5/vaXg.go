...
func getNFOTokens() ([]string, error) {
	...
	niftyStrikeRanges := calculateStrikePriceRanges(nifty50LastTradePrice,
		niftyMaxCEMultiplier,
		niftyMinCEMultiplier)

	niftybankStrikeRanges := calculateStrikePriceRanges(niftybankLastTradePrice,
		niftybankMaxCEMultiplier,
		niftybankMinCEMultiplier)
