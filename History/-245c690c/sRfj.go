...
func NewADXEMIRSILongStrategy(close, adx, plusDI, minusDI, sma20, ema10, ema20, ema60, rsi, psar []float64, adxThreshold float64, rsiThreshold float64) Strategy {
	...
	entryCrossUpRule := rules.Or(plusDICrossUpMinusDIRule, ema10CrossUpEma20Rule, adxCrossAboveThresholdRule, rsiCrossAboveThresholdRule, closeCrossUpSMA20EntryRule, closeCrossUpEMA60EntryRule, closeCrossUpPsarEntryRule)
	...
	entryVerificaionRule := rules.And(plusDIOverMinusDIRule, ema10OverEma20Rule, adxOverThresholdRule, rsiOverThresholdRule, closeOverSMA20Rule, closeOverEMA60Rule, closeOverPsarRule)
	...
	plusDICrossoverEntryRule := rules.And(plusDICrossUpMinusDIRule, adxOverThresholdRule)
