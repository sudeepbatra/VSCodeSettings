...
func getNFOTokens() ([]string, error) {
	...
	nifty50MaxCEStrike := nifty50IndiceLastTradePrice + 500.0
	nifty50MinCEStrike := nifty50IndiceLastTradePrice - 100.0
	nifty50MaxPEStrike := nifty50IndiceLastTradePrice + 100.0
	nifty50MinPEStrike := nifty50IndiceLastTradePrice - 500.0

	niftybankMaxCEStrike := niftybankIndiceLastTradePrice + 1000.0
	niftybankMinCEStrike := niftybankIndiceLastTradePrice - 200.0
	niftybankMaxPEStrike := niftybankIndiceLastTradePrice + 200.0
	niftybankMinPEStrike := niftybankIndiceLastTradePrice - 1000.0
