...
func NewADXEMIRSILongStrategy(close, adx, plusDI, minusDI, sma20, ema10,
	ema20, ema60, rsi, psar []float64, adxThreshold float64, rsiThreshold float64) Strategy {
	...
	closeUnderEma10Rule := rules.NewUnderIndicatorRule(close, ema10, true)
	closeUnderEma20Rule := rules.NewUnderIndicatorRule(close, ema20, true)
