...
func init() {
	...
	initialzeBotCmd.Flags().StringVarP(&exchangeFlag, "exchangeFlag", "e", "NSE", "Specify the exchange to fetch the historical data for")
...
var initialzeBotCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		controller.InitializeAlphaHftSOD(smartApiTotp, createTable, populateOldHistoricData, useBrokersSavedState, useProxy, exchangeFlag)
	},
}
