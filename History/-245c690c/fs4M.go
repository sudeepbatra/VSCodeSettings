...
func NewADXEMIRSILongStrategy(close, adx, plusDI, minusDI, sma20, ema10,
	...
	adxCrossAboveThresholdRule := rules.NewCrossAboveRule(adx, adxThreshold, traceRule)
	rsiCrossAboveThresholdRule := rules.NewCrossAboveRule(rsi, rsiThreshold, traceRule)
