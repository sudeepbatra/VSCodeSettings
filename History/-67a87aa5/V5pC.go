...
const (
	...
	niftyMaxMultiplier            = 5.0
	niftyMinMultiplier            = 1.0
	niftybankMaxMultiplier        = 10.0
	niftybankMinMultiplier        = 2.0
)
...
func calculateStrikePriceRanges(lastTradePrice float64, maxMultiplier, minMultiplier float64) strikePriceRanges {
	return strikePriceRanges{
		MaxCE: lastTradePrice + maxMultiplier*100.0,
		MinCE: lastTradePrice - maxMultiplier*100.0,
		MaxPE: lastTradePrice + minMultiplier*100.0,
		MinPE: lastTradePrice - minMultiplier*100.0,
	}
}
