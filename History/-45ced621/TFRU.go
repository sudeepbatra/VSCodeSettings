...
func GetNiftyIndexLastValue() (float64, error) {
	var lastTradedPrice float64

	rows, err := AlphaHftDbConn.Query(context.Background(), NiftyIndiceLastTradePriceQuery)
	if err != nil {
		return last_nifty_indice_value, err
	}
