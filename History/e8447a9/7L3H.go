...
func NewIchimokuChikouCrossoverStrategy(chikou, value []float64) Strategy {
	entryRule := rules.NewChikouCrossUpRule(chikou, value, false)
	exitRule := rules.NewChikouCrossDownRule(chikou, value, false)
...
func (s *IchimokuChikouCrossoverStrategy) IsStrategyLive() bool {
	return false
}
