...
func (c *AlphaSignalDistribution) Subscribe() chan common.AlphaSignal {
	c.mu.Lock()
	defer c.mu.Unlock()

	logger.Log.Debug().Str("handler", "AlphaSignalDistribution").Msg("subscribing for live candlestick data")
