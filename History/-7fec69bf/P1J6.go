...
func InitializeTables() {
	...
	err = createLiveCandlestickTable()
	if err != nil {
...
func createLiveCandlestickTable() error {
	...
	liveCandlesticksIndexQuery := fmt.Sprintf("CREATE INDEX idx_token_exchange_timestamp ON live_candlesticks (token, exchange, duration, timestamp DESC);")
