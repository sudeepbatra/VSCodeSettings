...
var useProxy bool
var instrumentFilterFlag string
...
func init() {
	...
	initialzeBotCmd.Flags().StringVarP(&instrumentFilterFlag, "instrumentFilterFlag", "t", "NSE", "Specify the exchange to fetch the historical data for")
