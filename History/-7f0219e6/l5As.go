...
func unpackBestFiveData(data []byte) ([]BestFiveTickData, []BestFiveTickData, []BestFiveTickData, error) {
	var bestFiveData []BestFiveTickData

	var buyData []BestFiveTickData
	var sellData []BestFiveTickData
	...
	for i := 0; i < len(data); i += packetSize {
		...
		bestFivePacket := BestFiveTickData{
