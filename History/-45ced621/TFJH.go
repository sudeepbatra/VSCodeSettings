...
func GetInstrumentsSymbolAndTokenMapping() (map[string]int, map[int]string, error) {
	...
	tokenToSymbolMap := make(map[int]string)
	...
	for _, instrument := range instruments {
		...
		symbolToTokenMap[instrument.Symbol] = instrument.Token
		tokenToSymbolMap[instrument.Token] = instrument.Symbol
	}
