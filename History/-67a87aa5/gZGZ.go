...
func getNFOTokens() ([]string, error) {
	...
	nifty50IndiceLastTradePrice, niftybankIndiceLastTradePrice := getNifty50AndBankNiftyLTP(client)
	...
	for _, instrument := range instruments {
		if instrument.ExchSeg == "NFO" &&
			...
			case instrument.Name == "NIFTY" &&
				...
				instrumentStrike <= niftyStrikeRanges.MaxCE && instrumentStrike >= niftyStrikeRanges.MinCE && isValidOption:
