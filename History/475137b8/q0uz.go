...
func NewCandlestickStorage() *LiveCandlesticksStorage {
	logger.Log.Debug().Str("handler", "candlestick_storage").Msg("New LiveCandlesticksStorage Created!")
	return &LiveCandlesticksStorage{}
}

func (p *LiveCandlesticksStorage) StoreCandlesticks() {
	logger.Log.Trace().Str("handler", "candlestick_storage").Msg("LiveCandlesticksStorage started!")
