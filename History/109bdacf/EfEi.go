...
func SmartAPIMarketDataWS() {
	headers := http.Header{
		"Authorization": {"Bearer eyJhbGciOiJIUzUxMiJ9.eyJ0b2tlbiI6IlJFRlJFU0gtVE9LRU4iLCJpYXQiOjE2OTI3NTg4NTV9.XJyf8H9Nc4hKgvCdu2pde5L8vuxbWYrCCktt0FsMVGY-QmV2M0MJqVTMJaAq9djLBdBbo_2HPE14CZYP1MeBPw"},
		"x-api-key":     {"iGKWS2zU"},
