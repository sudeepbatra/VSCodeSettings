...
func processResponse(respBytes []byte) *TickParsedData {
	...
	if parsedData.SubscriptionMode == SnapQuote {
		...
		if err != nil {
			parsedData.Best5TickData = best5Data
...
func unpackBestFiveData(data []byte) ([]Best5TickData, []Best5TickData, []Best5TickData, error) {
	var best5Data, best5BuyData, best5SellData []Best5TickData
