	...
	for _, instrument := range instruments {
		if instrument.ExchSeg == "NFO" &&
			...
			case instrument.Name == "NIFTY" &&
				...
				instrumentStrike >= niftyStrikeRanges.MinCE &&
				isValidOption:
				nfoTokens = append(nfoTokens, instrument.Token)
			case instrument.Name == "NIFTY" &&
				instrument.OptionType == "PE" &&
				instrumentStrike <= niftyStrikeRanges.MaxPE &&
				instrumentStrike >= niftyStrikeRanges.MinPE &&
				isValidOption:
				nfoTokens = append(nfoTokens, instrument.Token)
			case instrument.Name == "BANKNIFTY" &&
				instrument.OptionType == "CE" &&
				instrumentStrike <= niftybankStrikeRanges.MaxCE &&
				instrumentStrike >= niftybankStrikeRanges.MinCE &&
				isValidOption:
				nfoTokens = append(nfoTokens, instrument.Token)
