...
func NewAlphaSignal(token int, symbol string, exchangeCode int, exchange, interval string,
	lastBarStartDuration time.Time, strategy, signal string, signalGenerationTime time.Time, price, o, h, l, c float64, v int,
	alphaSignalReason string, isHistorical bool,
) (*AlphaSignal, error) {
	switch signal {
