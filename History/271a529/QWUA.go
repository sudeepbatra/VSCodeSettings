...
func NewIchimokuLowHighEmaLongStrategy(low, high, ema10, ema20, chikou, psar []float64) Strategy {
	chikouCrossUpRule := rules.NewChikouCrossUpLowHighRule(chikou, close, traceRule)
	...
	chikouAboveRule := rules.NewChikouAboveRule(chikou, close, traceRule)
