...
func NewADXEMIRSILongStrategy(close, adx, plusDI, minusDI, sma20, ema10, ema20, ema60, rsi, psar []float64, adxThreshold float64, rsiThreshold float64) Strategy {
	...
	entryCrossUpRule := rules.Or(plusDICrossAboveMinusDIRule, ema10OverEma20Rule, adxCrossAboveThresholdRule, rsiCrossAboveThresholdRule, closeCrossUpSMA20EntryRule, closeCrossUpEMA60EntryRule, closeCrossUpPsarEntryRule)

	plusDICrossAboveMinusDIRule := rules.OverIndicatorRule(plusDI, minusDI, true)
