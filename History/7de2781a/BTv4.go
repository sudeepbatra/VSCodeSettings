...
func processResponse(respBytes []byte) {
	...
	_ = unpackData(respBytes[27:35], "I", parsedData.SequenceNumber)
	_ = unpackData(respBytes[35:43], "I", parsedData.ExchangeTimestamp)
	_ = unpackData(respBytes[43:51], "I", parsedData.LastTradedPrice)
...
func unpackData(binaryData []byte, byteFormat string, value interface{}) error {
	...
	case "I":
		var value int64
		if err := binary.Read(bytes.NewReader(binaryData), binary.LittleEndian, &value); err != nil {
	...
	default:
		return errors.New("Unsupported ByteFormat Unpack Data")
	}
