...
func GetInstrumentsSymbolAndTokenMapping() (map[smartapi.InstrumentSymbolKey]int, map[int]smartapi.InstrumentSymbolKey, error) {
	...
	symbolToTokenMap := make(map[smartapi.InstrumentSymbolKey]int)
	tokenToSymbolMap := make(map[int]smartapi.InstrumentSymbolKey)
	...
	for _, instrument := range instruments {
		...
		instrumentTokenKey := smartapi.InstrumentTokenKey{Symbol: instrument.Symbol, Exchange: instrument.ExchSeg}

		symbolToTokenMap[instrumentSymbolKey] = token
		tokenToSymbolMap[token] = instrumentSymbolKey
	}
