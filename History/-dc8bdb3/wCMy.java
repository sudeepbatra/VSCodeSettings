...
public class Test {
	public static void main(String[] args) throws IOException {
		try {
			...
			////////////////////////Initiate////////////////////////
			JSONObject creds = new JSONObject("{\"vk\":{\"password\":\"DevDas123\",\"dOB\":\"13101977\",\"appKey\":\"s76162#+U35414Y*S413=099_FA6P567\",\"secretKey\":\"I04M0Y9!5vP7G3ct53e395+41F27=621\",\"idirect_Userid\":\"SUDDEPBA\"}}");
...
//					"","ioc","0",""));
	...
	public static String getApiSession(JSONObject creds, String userId){
		try{
			...
			httpGet.setURI(URI.create("https://api.icicidirect.com/apiuser/login?api_key=s76162%23%2BU35414Y%2AS413%3D099_FA6P567"));
